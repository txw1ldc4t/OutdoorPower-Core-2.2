        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DealerEmployeeTypeId = table.Column<int>(nullable: false),
                    DealerEmployeeLoginCredentialsId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DealerInventories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QInventoryMakes", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "QInventoryModelOptions",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QInventoryModelOptions", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "QInventoryTypes",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QInventoryTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QInventoryModels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QInventoryModels_QInventoryMakes_QInventoryMakeId",
                        column: x => x.QInventoryMakeId,
                        principalTable: "QInventoryMakes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QInventoryModels_QInventoryTypes_TypeId",
                        column: x => x.TypeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QInventoryModels_QInventoryMakeId",
                table: "QInventoryModels",
                column: "QInventoryMakeId");

            migrationBuilder.CreateIndex(
                name: "IX_QInventoryModels_TypeId",
                table: "QInventoryModels",
                column: "TypeId");
        }
