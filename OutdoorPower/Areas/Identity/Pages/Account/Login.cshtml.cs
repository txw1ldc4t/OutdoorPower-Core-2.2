...
namespace OutdoorPower.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<DealerEmployeeLoginCredential> signInManager, ILogger<LoginModel> logger)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                claims.Add(new Claim(ClaimTypes.Role, "DealerOwner", ClaimValueTypes.String));
